                        ...
                        <div class="card-body p-0">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a href="{{ url('distributor/dashboard') }}"
                                    class="nav-link d-flex align-items-center {{ $type == 'dashboard' ? 'active' : '' }}"
                                    id="v-pills-dashboard-tab">
                                    <i class="fa-solid fa-home me-3"></i>
                                    <span>Dashboard</span>
                                </a>
                                <a href="{{ url('distributor/profile') }}"
                                    class="nav-link d-flex align-items-center {{ $type == 'profile' ? 'active' : '' }}"
                                    id="v-pills-profile-tab">
                                    <i class="fa-solid fa-user me-3"></i>
                                    <span>Profile</span>
                                </a>
                                <a href="{{ url('distributor/kyc') }}"
                                    class="nav-link d-flex align-items-center {{ $type == 'kyc' ? 'active' : '' }}"
                                    id="v-pills-kyc-tab">
                                ...
                                <a href="{{ url('distributor/my-acheivements') }}" class="nav-link d-flex align-items-center {{ $type == 'my-acheivements' ? 'active' : '' }}"  
                                    id="v-pills-my-acheivements-tab">
                                    <i class="fa-solid fa-trophy me-3"></i>
                                    <span>My Acheivements</span>
                                </a>
                            </div>
                        </div>
                    </div>
