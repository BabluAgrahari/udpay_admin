                            ...
                            <div class="tab-panel active" id="addresses">
                                <div class="edit-form-open">
                                    <div class="address-header-title ">
                                        <h3 class="tab-title" style="padding: 0px; border-bottom: none;">Address</h3>
                                        {{-- <button class="add-address addBtn">+ Add New Address</button> --}}
                                    </div>
                                    @if ($addresses->isEmpty())
                                        <div class="tab-content-body address-location-body">
                                            <div class="">
                                                ...
                                                {{-- <button class="text-white thm-btn addBtn">Add New Address</button> --}}

                                            </div>
                                        </div>
                                    @endif
                                    <div class="edit-form-box m-3" id="editForm">
                                        <form>
                                            <div class="row">
                                        ...
                                        @foreach ($addresses as $address)
                                            <div class="address-card selected">
                                                <div class="address-header">
                                                    ...
                                                    {{-- <button class="edit-link editBtn"><i class="fa-solid fa-pen"></i>
                                                        Edit</button> --}}
                                                </div>
                                                <p>{{ $address->user_add_1 }}, {{ $address->user_add_2 }},
                                                    {{ $address->land_mark }}</p>
                                                <p>{{ $address->user_city }}, {{ $address->user_state }},
                                                    {{ $address->user_zip_code }}, {{ $address->user_country }}</p>
                                                <p>{{ $address->user_add_mobile }}, {{ $address->alternate_mob }}</p>
                                                <p>{{ $address->address_for ?? 'Home' }}</p>
                                                {{-- <button class="select-btn selected-btn"><i
                                                        class="fa-solid fa-circle-check"></i> Selected Address</button> --}}
                                            </div>
                                        @endforeach
