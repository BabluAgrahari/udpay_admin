                          ...
                          <div class="tab-content-body">
                              <div class="">
                                  <div class="d-flex gap-3 ">
                                      <div class="">
                                          <h3 class="color-one mb-0 user-sort">{{ ucfirst($user->name[0]??'') }}{{ ucfirst($user->name[1]??'')  }}</h3>
                                      </div>
                                        ...
                                        @csrf
                                          <div class="row mb-3">
                                              ...
                                              <div class="col-sm-6 form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="mobile" placeholder="Enter phone" value="{{ $user->mobile }}">
                                              </div>
                                          </div>
                                          <button type="button" class="thm-btn" id="saveBtn">Save Address</button>
  ...
  <script>
    ...
    $("#saveBtn").click(function(e) {
      ...
      $.ajax({
        ...
        data: formData,
        beforeSend: function() {
          $("#saveBtn").html('<i class="fa-solid fa-spinner fa-spin"></i> Saving...').prop("disabled", true);
          $("#cancelBtn").prop("disabled", true);
        },
        success: function(response) {
          if (response.status ) {
            $("#saveBtn").html('Save Address').prop("disabled", false);
