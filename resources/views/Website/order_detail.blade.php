                              ...
                              <div class="order-card">
                                  ...
                                  <div class="order-details">
                                      ...
                                      <div class="order-actions">
                                          ...
                                          @if(Auth::check())
                                          <span class="review-link" onclick="openReviewModal({{ $orderToProduct->product->id }}, '{{ $orderToProduct->product->product_name }}')">
            ...
            <div class="modal-body">
                <form id="reviewForm" class="review-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="review" name="review" placeholder="Share your experience with this product (minimum 10 characters)..." required></textarea>
