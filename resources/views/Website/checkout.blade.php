                        ...
                        <form method="POST" action="{{ route('checkout.form') }}">
                            ...
                            <div class="row">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="text" name="user_add_name" class="form-control" placeholder="Enter Name" value="{{ old('user_add_name') }}" />
                                    @error('user_add_name')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>Mobile No. <span class="color-red">*</span></label>
                                    <input type="text" name="user_add_mobile" class="form-control" placeholder="Enter Phone" value="{{ old('user_add_mobile') }}" />
                                ...
                                <div class="col-sm-12 form-group">
                                    ...
                                    <textarea name="user_add_1" class="form-control" placeholder="Enter Addresses">{{ old('user_add_1') }}</textarea>
                                    @error('user_add_1')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>Landmark</label>
                                    <input type="text" name="land_mark" class="form-control" placeholder="Enter Landmark" value="{{ old('land_mark') }}" />
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>Pincode <span class="color-red">*</span></label>
                                    <input type="text" name="user_zip_code" class="form-control" placeholder="Enter Pincode" value="{{ old('user_zip_code') }}" />
                                    @error('user_zip_code')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>State <span class="color-red">*</span></label>
                                    <input type="text" name="user_state" class="form-control" placeholder="Enter State" value="{{ old('user_state') }}" />
                                    @error('user_state')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>City <span class="color-red">*</span></label>
                                    <input type="text" name="user_city" class="form-control" placeholder="Enter City" value="{{ old('user_city') }}" />
                                    @error('user_city')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                            </div>
