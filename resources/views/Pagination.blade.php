    ...
    <div class="col-md-6 mt-3">
        <nav aria-label="Page navigation">
            <ul class="pagination justify-content-end">
                ...
                @else
                <li class="page-item first"><a href="{{ $paginator->previousPageUrl() }}" class="page-link" rel="prev"><i class="tf-icon bx bx-chevrons-left bx-sm"></i></a></li>
                @endif
                ...
                <li class="disabled page-item first"><span>{{ $element }}</span></li>
                @endif
                ...
                <li class="page-item last"><a class="page-link" href="{{ $paginator->nextPageUrl() }}" rel="next"><i class="tf-icon bx bx-chevrons-right bx-sm"></i></a></li>
                @else
