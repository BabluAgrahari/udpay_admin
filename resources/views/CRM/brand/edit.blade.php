                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="meta_title" id="meta_title" class="form-control"
                            placeholder="Enter meta title for SEO" value="{{ $brand->meta_title }}">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="meta_keyword" id="meta_keyword" class="form-control"
                            placeholder="Enter meta keywords separated by commas" value="{{ $brand->meta_keyword }}">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea name="meta_description" id="meta_description" class="form-control"
                            rows="3" placeholder="Enter meta description for SEO">{{ $brand->meta_description }}</textarea>
